# -*- coding: utf-8 -*-
"""
Created on Sat Sep 15 16:52:14 2018
...
def train_model(learning_rate, steps, batch_size, input_feature):
  ...
  Args:
    ...
    input_feature: A `string` specifying a column from `ecnm_dataframe`
  ...
  my_feature_data = ecnm_dataframe[[my_feature]]
  my_label = "tw_Adj_Close"
  targets = ecnm_dataframe[my_label]
...
ecnm_dataframe["tw_chn"] = (
    ecnm_dataframe["tw_VALUE"] / ecnm_dataframe["chn_VALUE"])

calibration_data = train_model(
    learning_rate=0.001,
    steps=1000,
    batch_size=1,
    input_feature="tw_chn")